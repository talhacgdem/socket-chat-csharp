    ...
    public partial class Server : Form
    {
            ...
            if (!exit)
            {
                startButton.Invoke((MethodInvoker)delegate
                {
                    ...
                    if (status)
                    {
                        ...
                        startButton.Text = "Kapat";
                        Log(SystemMsg("Server başlatıldı"));
                    }
                    else
                    {
                        ...
                        Log(SystemMsg("Server kapatıldı"));
                    }
                });
            }
        }
        ...
        private void Connection(MyClient obj)
        {
            if (Authorize(obj))
            {
                ...
                string msg = string.Format("{0} baglandı", obj.username);
                Log(SystemMsg(msg));
                ...
                msg = string.Format("{0} ayrıldı", tmp.username);
                Log(SystemMsg(msg));
                Send(msg, tmp.id);
            }
        }
        ...
        private void StartButton_Click(object sender, EventArgs e)
        {
            ...
            else if (listener == null || !listener.IsAlive)
            {
                ...
                {
                    error = true;
                    Log(SystemMsg("Port numarası yanlış aralıkta"));
                }
        ...
        private void SendTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (sendTextBox.Text.Length > 0)
                {
                    ...
                    sendTextBox.Clear();
                    Log(string.Format("{0} (SERVER): {1}", usernameTextBox.Text.Trim(), msg));
